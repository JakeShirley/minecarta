/**
 * Block color definitions for map rendering
 *
 * These colors are used when sending block updates to the server
 * to provide the map color directly from the behavior pack.
 */

import type { RGBA } from '@minecraft-map/shared';

/**
 * Default fallback color (magenta to indicate missing texture/color)
 */
const DEFAULT_COLOR: RGBA = { r: 255, g: 0, b: 255, a: 255 };

/**
 * Common block colors mapping
 */
const BLOCK_COLORS: Record<string, RGBA> = {
  ...
  'minecraft:grass_block': { r: 124, g: 189, b: 107 },
  ...
  'minecraft:oak_log': { r: 58, g: 35, b: 20 },
  ...
  'minecraft:glass': { r: 255, g: 255, b: 255, a: 40 },
  ...
  'minecraft:torch': { r: 255, g: 255, b: 0, a: 0 },
  ...
  'minecraft:ladder': { r: 255, g: 255, b: 255, a: 0 },
...
/**
 * Get the map color for a block type
 *
 * @param blockType - The block type identifier (e.g., 'minecraft:stone' or 'stone')
 * @returns RGBA color for the block
 */
export function getBlockColor(blockType: string): RGBA {
  // Normalize string (add namespace if not provided)
  ...
  // Return fallback color (magenta indicates missing color)
